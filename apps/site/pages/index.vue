...
<template>
  <div class="space-y-24 md:space-y-28">
    ...
    <section aria-label="Active projects" class="space-y-8">
      <div
        aria-hidden="true"
        class="bg-sm-orange group flex h-40 flex-col items-center justify-center gap-3 overflow-hidden rounded-2xl"
      >
        <div
          ...
          :key="index"
          class="flex h-5 items-center gap-3"
          :class="index === 1 ? 'sm:-translate-x-5' : 'sm:translate-x-5'"
        >
          <div
            v-if="index !== 1"
            class="bg-sm-black h-5 w-5 shrink-0 rounded-sm transition-transform duration-300 group-hover:translate-x-8"
          />
          <div
            :class="[
              width,
            ...
            class="h-1 rounded-full bg-white transition-transform duration-300"
          />
          <div
            v-if="index === 1"
            class="bg-sm-black h-5 w-5 shrink-0 rounded-sm transition-transform duration-300 group-hover:-translate-x-8"
      ...
      <div class="space-y-4 text-gray-300 md:px-[50px]">
        <p>
          Outside work, I spend time on a few projects of my own. They give me
          room to try new ideas, build useful tools, and refine the small
          details that make something enjoyable to use. These are the ones I'm
        ...
        <ul class="divide-y divide-gray-700">
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="focus-visible:outline-sm-blue hover:text-sm-blue shrink-0 text-right text-sm text-gray-300 transition-colors hover:underline focus-visible:rounded-sm focus-visible:underline focus-visible:outline-2 focus-visible:outline-offset-4"
            >
              {{ project.domain }}
            </a>
          </li>
    ...
    <section class="space-y-8">
      <div
        class="group flex h-40 items-center justify-center gap-x-4 rounded-2xl bg-white"
      >
        <div
      ...
      <div class="space-y-4 text-gray-300 md:px-[50px]">
        <p>
          Outside tech, I serve as a volunteer for the Italian Civil Protection
          in Lombardy, with training covering wildfire fighting, flood response,
        ...
        <p>
          I've kept this site minimal. If you're looking for my resume and want
          to learn more about my experience, you can find it at
          <a
            href="https://resume.smnl.dev/?ref=smnl.dev"
            target="_blank"
            rel="noopener noreferrer"
            class="hover:text-sm-blue text-white hover:underline focus-visible:underline"
