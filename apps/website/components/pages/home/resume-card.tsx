    ...
    <div className="mt-10 rounded-2xl bg-neutral-800/60 p-10 md:rounded-3xl md:p-12">
      ...
      <button
        className={classNames(
          'bg-sm-blue text-sm-white disabled:text-sm-white/50 disabled:bg-sm-blue/50 group z-10 mt-5 flex items-center gap-x-2 rounded-lg px-4 py-2 font-semibold transition-colors',
